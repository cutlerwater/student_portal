                        ...
                        if 'input' in request.POST:
                                ...
                                if input and int(input) >= 0:
                                        if first == 'fahrenheit' and second == 'celsius':
                                                answer = f'{input} fahrenheit = {(int(input)-32) * 5/9} celsius'
                                        if first == 'celsius' and second == 'fahrenheit':
                                                answer = f'{input} celsius = {(int(input)*9/5) + 32} fahrenheit'
                                context = { 'form': form, 'm_form': measurement_form, 'input':True, 'answer':answer}
        else:
                form = ConversionForm()
...
def profile(request):
        ...
        if len(todos) == 0:
                ...
                todo_done = False
        context = {'homework': homeworks, 'todos': todos, 'homework_done': homework_done, 'todos_done':todo_done}
